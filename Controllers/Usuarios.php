<?php 
	...
	class Usuarios extends Controllers{
		...
		public function setUsuario(){
			if($_POST){			
				if(empty($_POST['txtIdentificacion']) || empty($_POST['txtNombre']) || empty($_POST['txtApellidoPaterno'])  || empty($_POST['txtApellidoMaterno'])|| empty($_POST['txtTelefono']) || empty($_POST['txtEmail']) || empty($_POST['listIdRol']) || empty($_POST['listStatus']) )
				{
					...
					$intTipoId = intval(strClean($_POST['listIdRol']));
		...
		public function putPerfil(){
			if($_POST){
				if(empty($_POST['txtIdentificacion']) || empty($_POST['txtNombre']) || empty($_POST['txtApellidoPaterno']) || empty($_POST['txtApellidoMaterno']) || empty($_POST['txtTelefono']) )
				{
					$arrResponse = array("status" => false, "msg" => 'Datos incorrectos.');
				}else{
					...
					$strApellido = strClean($_POST['txtApellidoPaterno']);
					$strApellido = strClean($_POST['txtApellidoMaterno']);
					$intTelefono = intval(strClean($_POST['txtTelefono']));
					$strPassword = "";
