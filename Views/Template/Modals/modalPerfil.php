      ...
      <div class="modal-body">
            <form id="formPerfil" name="formPerfil" class="form-horizontal">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  <label for="txtApellido">Apellido Paterno <span class="required">*</span></label>
                  <input type="text" class="form-control valid validText" id="txtApellidoPaterno" name="txtApellidoPaterno" value="<?= $_SESSION['userData']['apellidopaterno']; ?>" required="">
                </div>
                <div class="form-group col-md-6">
                  <label for="txtApellido">Apellido Materno <span class="required">*</span></label>
                  <input type="text" class="form-control valid validText" id="txtApellidoMaterno" name="txtApellidoMaterno" value="<?= $_SESSION['userData']['apellidomaterno']; ?>" required="">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
