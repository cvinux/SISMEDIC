...
document.addEventListener('DOMContentLoaded', function(){
    ...
    if(document.querySelector("#formUsuario")){
        ...
        formUsuario.onsubmit = function(e) {
            ...
            let intTipousuario = document.querySelector('#listIdRol').value;
            let strPassword = document.querySelector('#txtPassword').value;
            let intStatus = document.querySelector('#listStatus').value;

            if(strIdentificacion == '' || strApellidoPaterno == ''  || strApellidoMaterno == '' || strNombre == '' || strEmail == '' || intTelefono == '' || intTipousuario == '')
            {
                ...
                if(request.readyState == 4 && request.status == 200){
                    ...
                    if(objData.status)
                    {
                        if(rowTable == ""){
                            ...
                            rowTable.cells[2].textContent = strApellidoPaterno; 
                            rowTable.cells[3].textContent = strApellidoMaterno; 
                            rowTable.cells[4].textContent = intTelefono;
                            rowTable.cells[5].textContent = strEmail;
                            rowTable.cells[6].textContent = intTelefono;
                            rowTable.cells[7].textContent = document.querySelector("#listIdRol").selectedOptions[0].text;
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
               let estadoUsuario = objData.data.status == 1 ? 
                ...
                document.querySelector("#celApellidoPaterno").innerHTML = objData.data.apellidopaterno;
                document.querySelector("#celApellidoMaterno").innerHTML = objData.data.apellidomaterno;
    ...
    request.onreadystatechange = function(){
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#txtApellidoPaterno").value = objData.data.apellidopaterno;
                document.querySelector("#txtApellidoMaterno").value = objData.data.apellidomaterno;
